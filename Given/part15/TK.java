...
public class TK {
    ...
    public static final TK ELEMENT   = new TK("TK.ELEMENT");   // element
    public static final TK INDEX   	 = new TK("TK.INDEX");   	// index
    public static final TK FORWARD   = new TK("TK.FORWARD");   // forward
    public static final TK REVERSE   = new TK("TK.REVERSE");   // reverse
    ...
    public static final TK STRING = new TK("TK.STRING");   // string
